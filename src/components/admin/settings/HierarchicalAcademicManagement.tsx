...
export function HierarchicalAcademicManagement() {
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      ...
      toast({
        title: 'บันทึกสำเร็จ',
        description: 'ข้อมูลทั้งหมดได้รับการอัปเดตเรียบร้อยแล้ว',
      });
    } catch (error) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>จัดการข้อมูลวิชาการแบบลำดับชั้น</CardTitle>
        <CardDescription>
          จัดการข้อมูล คณะ → สาขา → หลักสูตร → วิชาเอก แบบลำดับชั้น
        </CardDescription>
      </CardHeader>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      value={faculty.code || ''}
                      onChange={(e) => handleFacultyChange(faculty.id, 'code', e.target.value)}
                      placeholder="เช่น FST"
                    />
                  </div>
                </div>
                <div className="flex gap-2">
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => handleAddDepartment(faculty.id)}
                  >
                        ...
                        <div className="flex items-center gap-4 mb-3">
                          ...
                          <div className="flex gap-2">
                            <Button
                              variant="outline"
                              size="sm"
                              onClick={() => handleAddCurriculum(department.id)}
                            >
                              <PlusCircle className="h-4 w-4 mr-1" />
                              เพิ่มหลักสูตร
                            </Button>
                                ...
                                <div key={curriculum.id} className="border-l-2 border-green-200 pl-4">
                                  <div className="flex items-center gap-4 mb-3">
                                    <Button
                                      variant="ghost"
                                      size="sm"
                                      onClick={() => toggleExpanded(curriculum.id)}
                                    >
                                    ...
                                    <div className="flex gap-2">
                                      <Button
                                        variant="outline"
                                        size="sm"
                                        onClick={() => handleAddMajor(curriculum.id)}
                                      >
                                        <PlusCircle className="h-4 w-4 mr-1" />
                                        เพิ่มวิชาเอก
                                      </Button>
                                  ...
                                  {expandedItems.has(curriculum.id) && (
                                    <div className="ml-8 space-y-2">
                                      {majors
                                        .filter(m => m.curriculumId === curriculum.id)
                                        .map((major) => (
                                            ...
                                            <div className="flex items-center gap-4">
                                              <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-4">
                                                ...
                                                <div>
                                                  ...
                                                  <Input
                                                    value={major.area || ''}
                                                    onChange={(e) => handleMajorChange(major.id, 'area', e.target.value)}
