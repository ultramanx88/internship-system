import type { User, Internship, Application, ProgressReport, AcademicTerm, Holiday, UserRoleGroup, UserTitle, Major, CompanyEvaluation, CompanyEvaluationQuestion, Faculty, Role } from './types';
