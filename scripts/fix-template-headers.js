...
// แก้ไขเทมเพลตให้ไม่มีส่วนหัวซ้ำ
function fixTemplateHeaders() {
  const templates = {
    internship: {
      th: {
        request_letter: {
...
<div class="document-page">
  ...
  <div class="student-list">
    ...
    co_op: {
      th: {
        // แบบฟอร์มสหกิจศึกษา - ลบส่วนหัวออก
        application_form: {
...
<div class="document-page">
  ...
  // CSS ที่ปรับปรุงแล้ว - ลบ CSS ส่วนหัวที่ไม่ใช้
  const improvedCSS = `
  .document-page {
  ...
  // สร้างไฟล์ TypeScript ใหม่
  const tsContent = `// เทมเพลต HTML ที่แก้ไขส่วนหัวแล้ว
...
`;
  ...
  console.log('✅ แก้ไขส่วนหัวเทมเพลตสำเร็จ:', outputFile);
  console.log('🎯 ลบส่วนหัวซ้ำออกจากแบบฟอร์มสหกิจศึกษาแล้ว');
}
